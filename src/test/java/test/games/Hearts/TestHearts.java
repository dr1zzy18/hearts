...
public class TestHearts {
    ...
    public void testEndTurnWithRoundWinner() {
        ...
        gameState.currentRoundCards.add(new AbstractMap.SimpleEntry<>(play0.playerID, play0.card));

        // Player 1 played Club 2
        Play play1 = new Play(1, new FrenchCard(FrenchCard.FrenchCardType.Number, FrenchCard.Suite.Clubs, 2));
        gameState.currentRoundCards.add(new AbstractMap.SimpleEntry<>(play1.playerID, play1.card));
        ...
        gameState.currentRoundCards.add(new AbstractMap.SimpleEntry<>(play2.playerID, play2.card));
        ...
        // Call _endTurn
        forwardModel._endTurn(gameState);
    ...
    public void testEndTurnTrickDeck() {
        ...
        assertTrue(gameState.currentRoundCards.isEmpty());
    ...
    public void testEndTurnNewRound() {
        ...
        // Initially, the current round is 1
    ...
    public void testSetCurrentPlayer() {
        ...
        // Verify that the current player was set correctly
